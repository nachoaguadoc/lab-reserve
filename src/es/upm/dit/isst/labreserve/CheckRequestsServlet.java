...
public class CheckRequestsServlet extends HttpServlet {
  private static final Long serialVersionUID = 1L;
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		List<Request> requests = dao.listRequests();
		req.getSession().setAttribute("requests", new ArrayList<Request>(requests));
